...
import { OeuvreSimular, PopularComedy } from "../../constants/RomanData"
...
function ComedyDetails() {
    ...
    const item = PopularComedy.find((item) => item.name === name);
            ...
            <div className="infos-infos">
               ...
               <div className='infos-date'>
                ...
                <div className='roman-button'>
                    <button className='butt1' onClick={codeAchat}>Acheter</button> 
                    <button className='butt2' onClick={codeEmprunt}>Emprienter</button>
