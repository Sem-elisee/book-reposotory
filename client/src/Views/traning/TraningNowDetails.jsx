...
import { OeuvreSimular, TrendingNow } from "../../constants/RomanData"
...
export default function () {
    ...
    const item = TrendingNow.find((item) => item.name === name);
                ...
                <div className="infos-infos">
                   ...
                   <div className='infos-date'>
                    ...
                    <div className='roman-button'>
                        <button className='butt1' onClick={Handlecode}>Acheter</button>
                        <button className='butt2'onClick={Handleemprunt}>Emprienter</button>
